...
> **Important:** Make sure you set the `GIGBRANCH` environment variable to **9.1.0** before running `jsinit.sh`. This version of 0-orchestrator will only work with this version of JumpScale.
