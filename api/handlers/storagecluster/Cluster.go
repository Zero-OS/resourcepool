...
type Cluster struct {
	DataStorage     []*StorageServer     `yaml:"dataStorage" json:"dataStorage" validate:"nonzero"`
	...
	MetadataStorage []*StorageServer     `yaml:"metadataStorage" json:"metadataStorage" validate:"nonzero"`
